...
- [x] Sensible defaults for enabled properties and filters for every view.  (Show Claude these defaults).  Installation of Planner and clicking the generate Bases button in settings should create these Bases file using these defaults.  
