...
| ++arrow-up++ / ++k++ | Navigate up (Kanban) |
| ++arrow-down++ / ++j++ | Navigate down (Kanban) |
| ++arrow-left++ / ++h++ | Navigate left (Kanban) |
| ++arrow-right++ / ++l++ | Navigate right (Kanban) |
| ++enter++ | Open focused item |
| ++escape++ | Clear focus |

## Next Steps

- [Configure settings](configuration.md) to customize statuses, priorities, and colors
- Learn about [recurring events](recurring-events.md)
- Explore all [keyboard shortcuts](keyboard-shortcuts.md)
